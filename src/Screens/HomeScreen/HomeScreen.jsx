...
export default function Home() {
  ...
  useEffect(() => {
    if (location.state?.nombreUsuario) {
      sessionStorage.setItem('nombreUsuario', location.state.nombreUsuario);
    }
  }, [location.state?.nombreUsuario]);
